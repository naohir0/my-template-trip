...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.diary_alter').each(function (i, e) {
  ...
  button.click(function () {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default.a.post("/title/".concat(titleId, "/alter/d"), {
      ...
      var subTimesBox = data.subTimesLine.split('/n');
      var subImpressionBox = data.subImpressionLine.split('/n');
      var subLocationBox = data.subLocationLine.split('/n');
      var subPictBox = data.subPictLine.split('/n');

      if (titleName) {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.diary-title').text("".concat(titleName));
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.diary-updateAt').text("\u65E5\u8A18\u4F5C\u6210\u65E5\uD83D\uDD50\uFF1A".concat(updateAt));
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.bl_listDisplay_img__diary').addClass('hidden_display');
      }

      for (var _i = 0; _i < subTitleBox.length; _i++) {
        if (subTitleBox[_i]) {
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(".sub-title".concat(_i + 1)).text("".concat(subTitleBox[_i]));
          ...
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(".sub-times".concat(_i + 1)).removeClass('hidden_display');
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(".sub-location".concat(_i + 1)).removeClass('hidden_display');
        } else {
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(".sub-title".concat(_i + 1)).text("");
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(".sub-impression".concat(_i + 1)).text("");
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(".sub-times".concat(_i + 1)).text("");
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(".sub-location".concat(_i + 1)).text("");
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(".sub-img".concat(_i + 1)).attr('src', '');
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(".sub-img".concat(_i + 1)).addClass('hidden-img');
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(".sub-title".concat(_i + 1)).addClass('hidden_display');
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(".sub-impression".concat(_i + 1)).addClass('hidden_display');
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(".sub-times".concat(_i + 1)).addClass('hidden_display');
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(".sub-location".concat(_i + 1)).addClass('hidden_display');
        }
      }
    });
  });
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.del-diaryItem-temp').each(function (i, e) {
  var button = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e);
  button.click(function () {
    button.next().filter('.confirm-cont').removeClass('confirm-del-hidden');
  });
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cancel-del-diaryItem').click(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.confirm-cont').addClass('confirm-del-hidden');
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.add-making-diarysubItem').each(function (i, e) {
  var button = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e);
  button.click(function () {
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.remove-making-diarysubItem').each(function (i, e) {
  var button = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e);
  button.click(function () {
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.list_alter').each(function (i, e) {
  ...
  button.click(function () {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default.a.post("/list/".concat(listId, "/alter/d"), {
      ...
      var listItemName = data.listItemName;
      var listItemPlace = data.listItemPlace;
      var listItemPict = data.listItemPict;
      var updateAt = data.updateAt;
      var insertAt = data.insertAt;
      var listCommentTitleBox = data.listCommentTitle.split('/n');
      var listCommentContBox = data.listCommentCont.split('/n');
      var listComment_length = listCommentTitleBox.length;

      if (listItemName) {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.bl_listDisplay').removeClass('hidden_display');
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.list-name').text(listItemName);
      ...
      if (listItemPict) {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.list-pict').removeClass('hidden-img');
      } else {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.list-pict').addClass('hidden-img');
      }

      for (var _i2 = 0; _i2 < 10; _i2++) {
        if (listCommentTitleBox[_i2]) {
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(".list-comment-title".concat(_i2 + 1)).text("".concat(_i2 + 1, "\u3000").concat(listCommentTitleBox[_i2]));
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(".list-comment-cont".concat(_i2 + 1)).text("\u3000".concat(listCommentContBox[_i2]));
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(".list-comment-title".concat(_i2 + 1)).removeClass('hidden_display');
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(".list-comment-cont".concat(_i2 + 1)).removeClass('hidden_display');
        } else {
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(".list-comment-title".concat(_i2 + 1)).text('');
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(".list-comment-cont".concat(_i2 + 1)).text('');
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(".list-comment-title".concat(_i2 + 1)).addClass('hidden_display');
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(".list-comment-cont".concat(_i2 + 1)).addClass('hidden_display');
        }
      }
    });
  });
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.del-listItem-temp').each(function (i, e) {
  var button = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e);
  button.click(function () {
    button.next().removeClass('confirm-del-list-hidden');
  });
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cancel-del-listItem').each(function (i, e) {
  var button = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e);
  button.click(function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.confirm-del-list').addClass('confirm-del-list-hidden');
  });
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.shared_diary_alter').each(function (i, e) {
  ...
  button.click(function () {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default.a.post("/title/".concat(titleId, "/alter/d"), {
      ...
      if (titleName) {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.shared-diary-title').text("".concat(titleName));
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.shared-diary-updateAt').text("\u65E5\u8A18\u4F5C\u6210\u65E5\uFF1A".concat(updateAt));
      ...
      for (var _i3 = 0; _i3 < subTitleBox.length; _i3++) {
        if (subTitleBox[_i3]) {
          ...
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(".shared-sub-times".concat(_i3 + 1)).removeClass('hidden_display');
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(".shared-sub-location".concat(_i3 + 1)).removeClass('hidden_display');
        } else {
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(".shared-sub-title".concat(_i3 + 1)).text("");
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(".shared-sub-impression".concat(_i3 + 1)).text("");
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(".shared-sub-times".concat(_i3 + 1)).text("");
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(".shared-sub-location".concat(_i3 + 1)).text("");
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(".shared-sub-img".concat(_i3 + 1)).attr('src', '');
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(".shared-sub-img".concat(_i3 + 1)).addClass('hidden-img');
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(".shared-sub-title".concat(_i3 + 1)).addClass('hidden_display');
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(".shared-sub-impression".concat(_i3 + 1)).addClass('hidden_display');
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(".shared-sub-times".concat(_i3 + 1)).addClass('hidden_display');
